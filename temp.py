# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 14:24:38 2020

@author: sevca
"""
from database_access import DatabaseAccess
db_file = r"amazon_reviews_us_PC_v1_00_2015_top10000_bad1.db"
db_file = os.getcwd() + '\data\\' + db_file

db = DatabaseAccess(db_file)
print(db.retrieve_top_worst_products(n=10, star_rating=4))
...
def get_reviews():
    ...
    db = DatabaseAccess(db_file)
    return db.retrive_reviews(product_id="B0051VVOB2", star_rating=4)
...
cleaned_review_bodys = preproc.clear_reviews(original_review_bodys, data_size=2500)
