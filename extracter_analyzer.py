    ...
    for pattern in patterns:
        for chunk in phrases:
            if search(pattern, chunk[1]) is not None:
                ...
                print("Opinion word: ", search_opinion_word(chunk[0], chunk[1]))
                print()
...
find_matched_phrases(get_words_and_postags(two_element_ngrams), two_element_patterns)
print(">> ---- <<")
find_matched_phrases(get_words_and_postags(three_element_ngrams), three_element_patterns)